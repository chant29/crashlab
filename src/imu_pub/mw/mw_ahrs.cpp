...
namespace ntrex
{
  ...
  MwAhrsRosDriver::MwAhrsRosDriver(char *port, int baud_rat, int sel) : Node("MW_AHRS_ROS2")
  {
    ...
    this->declare_parameter("linear_acceleration_stddev", 0.1);
    this->declare_parameter("angular_velocity_stddev", 0.1);
    this->declare_parameter("magnetic_field_stddev", 0.1);
    this->declare_parameter("orientation_stddev", 0.1);
